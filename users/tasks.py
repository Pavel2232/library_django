...
def send_welcome_email_task(email_address: str, name: str):
    ...
    send_mail(
        ...
        message='''
Hi {name},
Thanks for signing up for our newsletter! You’re joining an amazing community of beauty lovers.
...
Want more?
Follow us on social media and get your daily dose of advice, behind-the-scenes looks and beauty inspiration:
